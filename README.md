...
- With all of this taken care of, you can *now* start archiving pages!
  ...
  - Use this naming scheme when the file save prompt comes: "WRD-(insert-username-here)(Concept/Adjust/Showcase)-(insert-number-here).html"
    ...
    - "Showcase" is for Tweets that aim to simply showcase features and/or facts already present in the original game, as well as any developed mods to showcase changes to the Werehog; usually in video format.
